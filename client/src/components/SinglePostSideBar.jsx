        ...
        <div className="w-full text-white font-rubik">
            ...
            <div className="w-[90%] h-[40px] m-3 p-2 flex justify-center text-white font-rubik ">
                <div className="w-full ml-[64px] flex">
                    <div className="w-[90%]">
                        <textarea value={inputText} onChange={(e) => setInputText(e.target.value)} className="w-full h-[40px] rounded-l-sm border border-gray-300 bg-[#313131] p-1"></textarea>
                    </div>
                    <div className="w-[10%] font-rubik"><button className="bg-green-500 h-[40px] w-[100px] hover:bg-green-600 cursor-pointer font-semibold flex justify-center items-center rounded-r-sm" onClick={handleCreatePost}>Post</button></div>
                </div>
            </div>
            <div className="w-[90%] h-[40px] m-3 p-2 flex justify-center ">
                <div className="w-full ml-[64px]">
                    <SinglePostComment postId={post._id} triggerMountComments={triggerMountComments} />
                </div>
            </div>
        </div>
    )
